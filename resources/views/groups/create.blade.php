<x-app-layout>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12 py-12">
        <div class="bg-white shadow-lg rounded p-6">
            <form action="{{ route('groups.store') }}" method="post" autocomplete="off" enctype="multipart/form-data">
                @csrf
                @if ($errors->any())
                    <div class="mb-4">
                ...
                <div class="mb-4">
                    <div class="grid grid-cols-2">
                        <div class="post-image">
                            <img id="img_group" class="w-56 h-56  object-cover object-center rounded-full" src="https://cdn.pixabay.com/photo/2016/04/22/04/57/graduation-1345143__340.png" class="img-rounded img-fluid" alt="">
                        </div>
                        <div class="">
